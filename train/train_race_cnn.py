...
try:
    ...
    race = np.load('imgs_64x64_race_p2.npy')
except:
...
if len(imgs) == 0:
    ...
    np.save('imgs_64x64gender', gender)
...
X_train, X_test, y_train, y_test = train_test_split(imgs, race, test_size=0.25, random_state=42)
...
learning_rate_reduction = ReduceLROnPlateau(monitor='loss',
                                            ...
                                            factor=0.5,
                                            min_lr=0.00001)
filepath="weights.best.race.hdf5"
...
dump(model, './models/cnn_race_p2.joblib')